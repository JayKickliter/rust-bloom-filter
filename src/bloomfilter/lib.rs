...
impl<T: ?Sized> Bloom<T> {
    ...
    pub fn new(bitmap_size: usize, items_count: usize) -> Self {
        ...
        let bitmap = vec![0; bitmap_bits as usize];
        ...
        T: Hash,
    {
        ...
        for k_i in 0..self.k_num {
            ...
            self.bitmap[bit_offset] += 1;
        }
    }

    /// Remove item from the bloom filter.
